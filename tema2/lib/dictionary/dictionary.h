...
const char str65[] PROGMEM = "sub nivelul marii";
const char str66[] PROGMEM = "nu ai vlanul null";
const char str67[] PROGMEM = "tie oricum nu iti iese nimic";
const char str68[] PROGMEM = "tu lucrezi ca sa lucrezi";
const char str69[] PROGMEM = "noi lucram corect pe etape";
const char str70[] PROGMEM = "perpetuezi greseala";
const char str71[] PROGMEM = "perspectiva";
const char str72[] PROGMEM = "in momentul de fata";
const char str73[] PROGMEM = "munca ta e zero";
const char str74[] PROGMEM = "nu va faceti programatori";
const char str75[] PROGMEM = "folositi doar packet tracer";
const char str76[] PROGMEM = "iti lipsesc elemente";
const char str77[] PROGMEM = "te-ai documentat?";
const char str78[] PROGMEM = "cablarea ta e zero";
const char str79[] PROGMEM = "isepistu";
const char str80[] PROGMEM = "la fel si voua copii";
const char str81[] PROGMEM = "spor la treaba, o zi buna";
const char str82[] PROGMEM = "nu ne intelegem";
const char str83[] PROGMEM = "nu prea ai fost pe aici";
const char str84[] PROGMEM = "nu pierdem din vedere primul semestru";
const char str85[] PROGMEM = "sintaxa";
const char str86[] PROGMEM = "scrie bine colega ta?";
const char str87[] PROGMEM = "vreau sa am pasul 2";
const char str88[] PROGMEM = "nu ai cu ce sa lucrezi";
const char str89[] PROGMEM = "asa e in tenis";
const char str90[] PROGMEM = "te las sa intri, dar fara prezenta";
const char str91[] PROGMEM = "scopul si durata";
const char str92[] PROGMEM = "cu ce ocazie pe la noi?";
const char str93[] PROGMEM = "ai pierdut trenul";
const char str94[] PROGMEM = "tot ce facem noi are sens";
const char str95[] PROGMEM = "cred ca ne mai trebuie un doctorat";
const char str96[] PROGMEM = "cati dintre voi aveti permis de conducere?";
const char str97[] PROGMEM = "axul drumului se mai numeste si refugiu";
...
const char *const dictionary[] PROGMEM = {
    ...
    str56, str57, str58, str59, str60, str61, str62, str63,
    str64, str65, str66, str67, str68, str69, str70, str71,
